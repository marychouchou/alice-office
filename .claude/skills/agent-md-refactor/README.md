...
**Note (this project):** `SKILL.md` in this directory is adapted for this repo — it
describes this project's existing structure (`CLAUDE.md` → `@AGENTS.md`, `docs/*.md`,
`.claude/rules/`) rather than the generic root/`.claude/` layout shown above. Use
`SKILL.md`; this README is the unmodified upstream description.

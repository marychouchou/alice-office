...
**Note (this project):** `SKILL.md` in this directory points to `AGENTS.md`'s "Git"
section for this repo's actual rules (allowed commit types, no auto-commit without
an explicit request, never commit `.env`/secrets) instead of restating them. This
README is the unmodified upstream description.

...
| **Low** | Cosmetic, rare edge cases | Next release | Typo, minor alignment, rare crash |
...
**Note (this project):** environment fields here assume a browser/OS/device
matrix; for this repo, "environment" means room ID, container image/commit,
and which channel (LINE vs first-party API) was used. See the simplified

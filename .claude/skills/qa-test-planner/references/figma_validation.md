...
**Note (this project):** not applicable — this repo has no frontend/Figma designs.
Kept for upstream fidelity only; `SKILL.md`'s boundary section says explicitly not
to use this.
